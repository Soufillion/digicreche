<template>
  <section id="room">
    ...
    <!-- Example: List of unassigned teachers with an "Assign" button -->
    <ul>
      <li v-for="teacher in unassignedTeachers" :key="teacher.id">
        {{ teacher.name }}
        <button @click="assignTeacher(teacher)">Assign</button>
      </li>
    </ul>
  </section>
</template>
